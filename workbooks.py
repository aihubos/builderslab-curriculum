...
from missions import mission_card, completion_banner
...
def markdown(book):
    ...
    text += ['## 마지막 게임 도전',f'https://aihubos.github.io/builderslab-curriculum/mission-{book["id"]}.html','6개 상황 미션을 모두 해결하면 보스를 클리어합니다. 힌트와 오답 재도전을 사용할 수 있어요. 실제 실습 결과도 직접 확인하세요.']
...
def render_workbooks(root, courses, head, footer):
    ...
    for c in courses:
        ...
        cards.append(f'<article class="workbook-card"><span class="pill">CLASS {c["number"]} · {count}단계</span><h2>{e(c["title"])}</h2><p>{e(c["outcome"])}</p><a class="button primary" href="{path}">실습 교재 열기 ↗</a><a class="text-link" href="assets/teaching/{slug}-workbook.pdf" download>인쇄용 교재 PDF ↓</a><a class="text-link" href="mission-{slug}.html">마지막 게임 도전 ↗</a><a class="text-link" href="{slug}.html">과정 소개</a></article>')
